...
דרישות הלקוח:
- ערים מבוקשות (אם רלוונטי): ${config.cities.join(', ')}
...
חשוב: לצורך בדיקה, אנא אשר (isMatch: true) כל פוסט שמציע דירה או חדר להשכרה, גם אם חסר מחיר או מספר חדרים בפוסט, וגם אם זו דירת שותפים. פסול רק פוסטים שאינם קשורים להשכרת דירה כלל או שחורגים מהמחיר המקסימלי אם הוא צוין.
